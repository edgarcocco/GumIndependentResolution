...
{
    [Activity(Label = "GumIndependentResolution"
        , MainLauncher = true
        , Icon = "@drawable/icon"
    ...
    public class GumIndependentResolutionActivity : Microsoft.Xna.Framework.AndroidGameActivity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            var game = new GumIndependentResolutionGame();
